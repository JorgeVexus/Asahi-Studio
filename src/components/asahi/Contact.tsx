...
export function Contact() {
  return (
    <section id="contact" className="relative overflow-hidden border-t border-foreground/15 bg-foreground text-background">
      <motion.div
        ...
        <div className="mt-20 grid gap-16 md:grid-cols-12">
          <div className="md:col-span-5 space-y-8">
            <div className="space-y-4">
              <a href="mailto:hola@asahi.studio"
            ...
            <div className="space-y-2 text-background/70">
              <p className="font-mono text-xs uppercase tracking-widest">CDMX · Guadalajara · Remoto</p>
